    ...
    export default function Home() {
      ...
      <div className="h-screen flex flex-col">
       ...
       <nav className="mt-6 pt-6 border-t border-zinc-800 flex flex-col gap-2 ">
          ...
          <a href="" className="text-sm text-zinc-400 hover:text-zinc-100">Rnb</a>
          <a href="" className="text-sm text-zinc-400 hover:text-zinc-100">Hip-hop amercano</a>
          <a href="" className="text-sm text-zinc-400 hover:text-zinc-100" >Rap moz</a>
          <a href="" className="text-sm text-zinc-400 hover:text-zinc-100">Rap Br</a>
        ...
        <h2 className="font-semibold text-3xl mt-10">Made for Edson A Macamo</h2>
      ...
      <footer className="bg-zinc-800 border-t border-zinc-788 p-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
        <Image src="/album.jpg" className="w-full" width={48} height={48} alt="Capa do Album"/>
        <div className="flex flex-col">
          <strong className="font-normal">Roupes</strong>
